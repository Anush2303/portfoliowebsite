  ...
  return(
        <div className="blog">
           <div className="rowimg" style={{paddingBottom:'7px'}}>
              <p className='titleanimate_ animate__animated animate__zoomIn khead'><i class="page fab fa-blogger-b"></i>Blog App</p>
           ...
           <div className="rowimgb animate__animated animate__zoomIn">
            ...
            <div class="card animate__animated animate__zoomIn" onMouseEnter={handlechange} onMouseLeave={change} style={_styles}>
              <div class="card-body">
                <h3 class="card-title desc"style={{paddingBottom:'2px'}}>It is an online blog website where you can compose and post your daily journals and blogs and also have a read about other people's views and messages.</h3>
                <div class="card-text">
                <h3 class="" style={styles}>FEATURES</h3>
                <h5>COMPOSE AND POST BLOG <i class="fas fa-user-plus icons" style={styles}></i></h5>
